...
func calculate(_ arg: String) -> Int {
    let expression = arg.split(separator: " ")
    var returnExpression: [String] = []
    
    for i in 0...(expression.count - 1) {
        returnExpression.append(String(expression[i]))
    }
    
    return calculate(returnExpression)
}
